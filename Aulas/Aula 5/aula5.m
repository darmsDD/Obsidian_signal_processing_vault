...
X=(1/Np)*fft(x);  %  Transformada de Fourier do sinal. Devido a forma que a trasformada de Fourier 
...
Xp=X(1,Np/2:end-1);  % só a parte positiva da transformada
figure;
stem(fp,abs(Xp))
xlabel('f')
ylabel('|X(f)|')
