...
% xn = awgn(x,noisex,'measured'); % adiciona ruído branco Gaussiano
% yn = awgn(y,noisey,'measured'); % adiciona ruído branco Gaussiano


figure;
subplot(211)
plot(1:length(x),x,'o-',1:length(x),xn)
xlabel('tempo')
ylabel('Entrada')
legend('com ruido','sem ruido')
subplot(212)
plot(1:length(y),y,'o-',1:length(y),yn)
xlabel('tempo')
ylabel('Saída')
legend('com ruido','sem ruido')
